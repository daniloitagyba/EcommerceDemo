...
var webHooksApi = builder.AddProject<Projects.Webhook_Api>("webhooks-api")
    .WithReference(rabbitMq)
    .WithReference(webhooksDb)
    .WithEnvironment("Identity__Url", identityEndpoint);

// Reverse proxies
builder.AddProject<Projects.ReverseProxy>("reverse-proxy")
...
// Apps
var webhooksClient = builder.AddProject<Projects.Webhook_Client>("webhooksclient", launchProfileName)
